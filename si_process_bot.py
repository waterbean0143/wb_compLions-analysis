...
def create_pdf_vector_retriever():
    urls = {
      "si_full_process": "https://drive.google.com/uc?export=download&id=1TNOhmUds7hMpwz3NO4QD-mO-J1sUJoEa",
      "si_full_qna": "https://drive.google.com/uc?export=download&id=17M1mnMZVl29EahbSVqzcyZEX8LYsx5ER"
    }
    all_docs = []
...
hybrid_prompt = PromptTemplate(
    ...
    template="""당신은SI 방법론문서에 기반한 전문가입니다.
...
query = st.chat_input("SI 이행론 및 절차 관련 질문을 입력하세요:")
if not query:
    st.stop()
